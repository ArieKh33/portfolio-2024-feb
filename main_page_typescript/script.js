var data = [
    {
        ...
        logo: "main_page_typescript/main_page_language_logos/html-logo.svg"
    },
    {
        id: "CSS3",
...
function listenToButton(language_button) {
    ...
    if (languageTitle && languageDescription && languageLogo) {        var result = data.find(function (item) { return item.id === language_button.id; });
